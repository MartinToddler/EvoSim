...
function telemetryFixture(tick: number): TelemetryDto {
  return {
    ...
    ecology: {
      biomass: [1000, 0, 0, 0, 0, 0],
      capacity: [2000, 0, 0, 0, 0, 0],
      intakeShare: [1, 0, 0, 0, 0, 0],
      processEfficiency: [0.84, 0.36, 0.36, 0.36, 0.36, 0.36],
      toxinResistance: 0,
      toxinDeaths: 0,
    },
